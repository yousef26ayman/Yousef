...
pygame.display.set_caption('Classic Donkey Kong yousef ayman')
...
peach2 = pygame.transform.scale(pygame.image.load('assets/images/peach/peach2.png'),
                                (2 * section_width, 3 * section_height))
fireball = pygame.transform.scale(pygame.image.load('assets/images/peach/fireball.png'),
                                  (1.5 * section_width, 2 * section_height))
fireball2 = pygame.transform.scale(pygame.image.load('assets/images/peach/fireball2.png'),
                                   (1.5 * section_width, 2 * section_height))
